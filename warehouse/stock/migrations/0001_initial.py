    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Received', 'Received'), ('Packed', 'Packed'), ('In_progress', 'In_progress'), ('Delivering', 'Delivering')], default='In_progress', max_length=30, verbose_name='Status')),
